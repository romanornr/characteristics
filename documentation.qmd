...
baseplot <- ggplot() +
  geom_point(data = dmd_patients_first_visit, aes(x = Age, y = GMV, color = "DMD")) +
  geom_point(data = dmd_patients_second_visit, aes(x = Age, y = GMV, color = "DMD")) +
  geom_line(data = dmd, aes(x = Age, y = TBV, group = ID, color = "DMD"), linetype = "line") +
  
  geom_point(data = hc_patients_first_visit, aes(x = Age, y = GMV, color = "HC")) +
  geom_point(data = hc_patients_second_visit, aes(x = Age, y = GMV, color = "HC")) +
  geom_line(data = hc, aes(x = Age, y = TBV, group = ID, color = "HC"), linetype = "line") +
  
  geom_smooth(data = dmd, aes(x = Age, y = GMV, color = "DMD"), method = "lm", se = FALSE) +
  geom_smooth(data = hc, aes(x = Age, y = GMV, color = "HC"), method = "lm", se = FALSE) +
  
  labs(title = "GMV vs TBV Ratio with Repeated Measures", x = "Age", y = "GMV:TBV", color = "Group") +
  theme_bw()
