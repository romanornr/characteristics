...
So we will further subset the DMD and HC groups based on patiend ID to distinguish adults, kids and the country they're from. Which in this case can be either the Netherlands or UK. We can count the amount of patients in each group with the nrow() function.
